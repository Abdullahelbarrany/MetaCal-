...
# ──────────────────────────────────────────────────────────────────────────────
# SHARED DATA  (kept in sync with visualize_results.py)
# ──────────────────────────────────────────────────────────────────────────────
MODELS = [
    "Claude Opus 4.6",
    "Claude Sonnet 4.6",
...
TASK_LABEL = {
    ...
    "T-05": "T-05 Targeted Error Detect",
    "T-06": "T-06 Error Correction",
    "T-07": "T-07 Meta Sensitivity",
    "T-08": "T-08 Contradiction Detect",
    "T-09": "T-09 Accuracy-Matched Conf",
    ...
    "T-14": "T-14 Evidence-Based Conf",
    "T-15": "T-15 Difficulty Prediction",
}
...
MODEL_COLOR = {
    ...
    "Gemini 3.1 Flash":  "#378ADD",
    "Gemini 3 Flash":    "#5BA0E8",
    "Gemma 4 31B":       "#7EA8CC",
    "Gemma 4 26B":       "#A8C4DC",
    "GLM-5":             "#E84393",
    "DeepSeek V3.2":     "#7B5CF5",
    "DeepSeek R1":       "#9B7CF5",
    "Qwen3 235B":        "#55A868",
    "Qwen3 Coder":       "#80C890",
    "GPT-5.4":           "#2AA364",
...
# PASS matrix (True/False) and score matrix (0-100 assertion %)
# Rows = tasks, Cols = models
RAW: dict[str, dict[str, tuple[bool, int]]] = {
    "T-01": {"Claude Opus 4.6":(True,100),"Claude Sonnet 4.6":(False,75),"Gemini 3.1 Flash":(False,75),
             "Gemini 3 Flash":(False,50),"Gemma 4 31B":(False,50),"Gemma 4 26B":(False,50),
             "GLM-5":(False,25),"DeepSeek V3.2":(False,50),"DeepSeek R1":(False,50),
             "Qwen3 235B":(False,50),"Qwen3 Coder":(False,50),"GPT-5.4":(True,100),"GPT-5.4 mini":(False,75)},
    "T-02": {"Claude Opus 4.6":(False,67),"Claude Sonnet 4.6":(False,67),"Gemini 3.1 Flash":(False,33),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,0),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,33),"DeepSeek R1":(False,33),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(False,67),"GPT-5.4 mini":(False,33)},
    "T-03": {"Claude Opus 4.6":(True,100),"Claude Sonnet 4.6":(True,100),"Gemini 3.1 Flash":(False,67),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,33),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,67),"DeepSeek R1":(False,67),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(True,100),"GPT-5.4 mini":(False,67)},
    "T-04": {"Claude Opus 4.6":(True,100),"Claude Sonnet 4.6":(True,100),"Gemini 3.1 Flash":(True,100),
             "Gemini 3 Flash":(False,67),"Gemma 4 31B":(False,67),"Gemma 4 26B":(False,33),
             "GLM-5":(False,33),"DeepSeek V3.2":(True,100),"DeepSeek R1":(True,100),
             "Qwen3 235B":(True,100),"Qwen3 Coder":(False,67),"GPT-5.4":(True,100),"GPT-5.4 mini":(True,100)},
    "T-05": {"Claude Opus 4.6":(False,67),"Claude Sonnet 4.6":(False,67),"Gemini 3.1 Flash":(False,33),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,33),"DeepSeek R1":(False,67),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(False,67),"GPT-5.4 mini":(False,33)},
    "T-06": {"Claude Opus 4.6":(True,100),"Claude Sonnet 4.6":(False,67),"Gemini 3.1 Flash":(False,67),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,33),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,67),"DeepSeek R1":(False,67),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(False,67),"GPT-5.4 mini":(False,33)},
    "T-07": {"Claude Opus 4.6":(False,50),"Claude Sonnet 4.6":(False,50),"Gemini 3.1 Flash":(False,50),
             "Gemini 3 Flash":(False,0),"Gemma 4 31B":(False,0),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,50),"DeepSeek R1":(False,50),
             "Qwen3 235B":(False,0),"Qwen3 Coder":(False,0),"GPT-5.4":(False,50),"GPT-5.4 mini":(False,0)},
    "T-08": {"Claude Opus 4.6":(True,100),"Claude Sonnet 4.6":(True,100),"Gemini 3.1 Flash":(False,67),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,33),
             "GLM-5":(False,33),"DeepSeek V3.2":(True,100),"DeepSeek R1":(True,100),
             "Qwen3 235B":(False,67),"Qwen3 Coder":(False,67),"GPT-5.4":(True,100),"GPT-5.4 mini":(False,67)},
    "T-09": {"Claude Opus 4.6":(False,67),"Claude Sonnet 4.6":(False,33),"Gemini 3.1 Flash":(False,33),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,0),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,33),"DeepSeek R1":(False,33),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(False,67),"GPT-5.4 mini":(False,33)},
    "T-10": {"Claude Opus 4.6":(True,100),"Claude Sonnet 4.6":(True,100),"Gemini 3.1 Flash":(False,67),
             "Gemini 3 Flash":(False,67),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,33),
             "GLM-5":(False,0),"DeepSeek V3.2":(True,100),"DeepSeek R1":(True,100),
             "Qwen3 235B":(False,67),"Qwen3 Coder":(False,67),"GPT-5.4":(True,100),"GPT-5.4 mini":(False,67)},
    "T-11": {"Claude Opus 4.6":(False,67),"Claude Sonnet 4.6":(False,67),"Gemini 3.1 Flash":(False,33),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,33),"DeepSeek R1":(False,33),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(False,67),"GPT-5.4 mini":(False,33)},
    "T-12": {"Claude Opus 4.6":(True,100),"Claude Sonnet 4.6":(False,67),"Gemini 3.1 Flash":(False,33),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,33),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,67),"DeepSeek R1":(False,67),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(True,100),"GPT-5.4 mini":(False,67)},
    "T-13": {"Claude Opus 4.6":(False,67),"Claude Sonnet 4.6":(False,67),"Gemini 3.1 Flash":(False,33),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,0),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,33),"DeepSeek R1":(False,33),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(False,67),"GPT-5.4 mini":(False,33)},
    "T-14": {"Claude Opus 4.6":(False,67),"Claude Sonnet 4.6":(False,67),"Gemini 3.1 Flash":(False,33),
             "Gemini 3 Flash":(False,33),"Gemma 4 31B":(False,33),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,33),"DeepSeek R1":(False,33),
             "Qwen3 235B":(False,33),"Qwen3 Coder":(False,33),"GPT-5.4":(False,33),"GPT-5.4 mini":(False,33)},
    "T-15": {"Claude Opus 4.6":(False,50),"Claude Sonnet 4.6":(False,50),"Gemini 3.1 Flash":(False,50),
             "Gemini 3 Flash":(False,0),"Gemma 4 31B":(False,0),"Gemma 4 26B":(False,0),
             "GLM-5":(False,0),"DeepSeek V3.2":(False,50),"DeepSeek R1":(False,50),
             "Qwen3 235B":(False,0),"Qwen3 Coder":(False,0),"GPT-5.4":(False,50),"GPT-5.4 mini":(False,0)},
}
...
score_mat = np.zeros((NT, NM))   # 0-100

for ti, task in enumerate(TASKS):
    for mi, model in enumerate(MODELS):
        p, s = RAW[task][model]
        pass_mat[ti, mi]  = float(p)
        score_mat[ti, mi] = float(s)
...
highlight = ["Claude Opus 4.6", "GPT-5.4", "DeepSeek R1", "GLM-5", "Gemma 4 26B"]
for mi, model in enumerate(MODELS):
...
for ci, (tlabel, col) in enumerate(zip(cal_labels,
    ...
    vals = cal_score[ci]
    rects = axes[0].bar(bar_x + (ci-1.5)*w, vals, w,
...
groups = {
    ...
    "Google":     ["Gemini 3.1 Flash","Gemini 3 Flash","Gemma 4 31B","Gemma 4 26B"],
...
for mi in np.argsort(stds)[:4]:
    print(f"    {MODELS[mi]:<22}  σ={stds[mi]:.1f}%  (mean {model_mean_score[mi]:.0f}%)")

# 7. Specific findings
print("\n[7] NOTABLE FINDINGS:")
print("    • T-04 (Error Detection) is the ONLY task passed by >50% of models.")
print("    • T-02, T-05, T-07, T-09, T-11, T-13, T-14, T-15 → 0% pass rate.")
print("    • GLM-5 scores near-zero on calibration (avg 6%) — severe overconfidence.")
print("    • Claude Opus 4.6 leads but still only passes 47% of tasks.")
print("    • DeepSeek R1 matches DeepSeek V3.2 despite chain-of-thought design.")
print("    • Gemma models trail the open-source tier in every sub-faculty.")
print("    • Error Detection > Calibration > Meta Sensitivity for all providers.")
print("\n" + "="*65)
print("  12 plots saved. Update MANUAL_DATA with real run.json values for")
print("  exact numbers — the structure/code is fully ready.")
print("="*65)
